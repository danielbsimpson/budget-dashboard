...
-- Generated: 2026-04-02  (updated with Student Loans tab)
--
...
create table if not exists public.future_snapshots (
    ...
    -- ── Student Loans ─────────────────────────────────────────────────────────
    sl_bal1          numeric      not null default 0,      -- Loan 1 (Direct Grad PLUS) balance
    sl_rate1         numeric      not null default 6.83,   -- Loan 1 annual interest rate %
    sl_bal2          numeric      not null default 0,      -- Loan 2 (Direct Unsubsidized) balance
...
-- Values from the latest row of current_data.csv (2026-04-02T12:41:56).
--
-- NOTE: ai_rows and oe_expense_rows reflect April 2026 one-time items.
-- The app auto-clears these at month rollover. Replace with '[]' for a
...
-- Values from the latest row of future_data.csv (2026-04-02T14:00:00),
...
insert into public.future_snapshots (
    ...
    -- Car Loan
    29970.98,              -- current loan balance
    7.89,                  -- annual interest rate %
    600.00,                -- monthly payment
    1000.00,               -- extra annual payment (April)
    '2026-04-02',          -- loan start date
    -- 401k
    ...
    3000.00,               -- annual bonus contribution
    36,                    -- current age
...
-- =============================================================================
-- VERIFICATION — uncomment and run to confirm rows were inserted correctly.
-- =============================================================================
